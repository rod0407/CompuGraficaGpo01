//Previo8									Lopez Lopez Jose Rodrigo
//Fecha de entrega: 05 de Abril de 2026		320098446
// 
// Std. Includes
#include <string>
...
int main()
{
    ...
    Model gompers((char*)"Models/Gompers.obj");
    glm::mat4 projection = glm::perspective(camera.GetZoom(), (float)SCREEN_WIDTH / (float)SCREEN_HEIGHT, 0.1f, 100.0f);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Dibujar Lámpara 2 
        model = glm::mat4(1.0f);
        // Aquí no sumé movelightPos para que esta luz sea estática, pero puedes sumárselo si quieres que ambas se muevan
