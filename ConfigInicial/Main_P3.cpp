...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Proyecciones y transformaciones basicas Lopez Lopez Jose Rodrigo", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
	   ...
	   model = glm::rotate( model, 0.5f, glm::vec3( 2.0f, 0.0f, 0.0f ) ); // use to compare orthographic and perspective projection
		...
		for (int i = 0; i < 4; i++) {
			model = glm::mat4(1.0f);
			model = glm::translate(model, posicionesPatas[i]);
