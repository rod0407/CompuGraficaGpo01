// Previo 11                       Lopez Lopez Jose Rodrigo 	
// Fecha de entrega : 25 de abril de 2026         320098446
...
void Animation() {
	...
	if (dogAnim == 1) {  // Walk animation
		if (!step) {   // State 1: extremidades hacia adelante
			RLegs += 0.3f;
			FLegs += 0.3f;
			head += 0.3f;
			tail += 0.3f;
		...
		else           // State 2: extremidades hacia atras
		{
			RLegs -= 0.3f;
			FLegs -= 0.3f;
			head -= 0.3f;
